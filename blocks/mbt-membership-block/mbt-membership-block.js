...
export default function decorate(block) {
  ...
  const cssLink = document.querySelector('.login-item1 .login-inner-item1 a').getAttribute('href');
  console.log(cssLink);
  const jsLink = document.querySelector('.login-item2 .login-inner-item1 a').getAttribute('href');
  console.log(jsLink);
