...
//   const navChild = document.querySelector('.logo-nav-block').children;
...
export default async function decorate(block) {
  ...
  const LiList = document.querySelector('.logo-nav-block-child-3 ul');
  Array.from(LiList.children).forEach((ulChildElement, index) => {
