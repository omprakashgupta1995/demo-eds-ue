...
const Swiper = (function () {
  ...
  function p(e) {
    return typeof window !== 'undefined' && void 0 !== window.HTMLElement
          ...
          void 0 !== r
            ...
            && (c(t[i]) && c(a[i])
              ? a[i].__swiper__
                ...
                : u(t[i], a[i])
              : !c(t[i]) && c(a[i])
                ? ((t[i] = {}), a[i].__swiper__ ? (t[i] = a[i]) : u(t[i], a[i]))
                : (t[i] = a[i]));
        }
      }
    }
  ...
  function h({ swiper: e, targetPosition: t, side: s }) {
    ...
    const c = (e, t) => (d === 'next' && e >= t) || (d === 'prev' && e <= t);
    const p = () => {
      ((n = new Date().getTime()), l === null && (l = n));
      const r = Math.max(Math.min((n - l) / o, 1), 0);
      const d = 0.5 - Math.cos(r * Math.PI) / 2;
      let u = i + d * (t - i);
  ...
  function b(e) {
    ...
    const n = s.body;
    const l = e.clientTop || n.clientTop || 0;
    const o = e.clientLeft || n.clientLeft || 0;
    const d = e === t ? t.scrollY : e.scrollTop;
    const c = e === t ? t.scrollX : e.scrollLeft;
  ...
  function E(e) {
    ...
    let s = e;
    if (s) {
      for (t = 0; (s = s.previousSibling) !== null;) s.nodeType === 1 && (t += 1);
      return t;
    }
  }
  function x(e, t) {
    ...
    return (
      I
        || (I = (function ({ userAgent: e } = {}) {
          const t = A();
          const s = r();
          const a = s.navigator.platform;
          const i = e || s.navigator.userAgent;
          const n = { ios: !1, android: !1 };
          const l = s.screen.width;
          const o = s.screen.height;
          const d = i.match(/(Android);?[\s\/]+([\d.]+)?/);
          let c = i.match(/(iPad)(?!\1).*OS\s([\d_]+)/);
          const p = i.match(/(iPod)(.*OS\s([\d_]+))?/);
          const u = !c && i.match(/(iPhone\sOS|iOS)\s([\d_]+)/);
          const m = a === 'Win32';
          let h = a === 'MacIntel';
          return (
            !c
  ...
  const Y = (e) => {
    ...
    if (!s || !t || t < 0) return;
    t = Math.min(t, s);
    const a = e.params.slidesPerView === 'auto'
  ...
  const H = {
    updateSize() {
      ...
      let t; let
        s;
      const a = e.el;
      ((t = void 0 !== e.params.width && e.params.width !== null
        ? e.params.width
        : a.clientWidth),
      (s = void 0 !== e.params.height && e.params.height !== null
        ? e.params.height
        : a.clientHeight),
      (t === 0 && e.isHorizontal())
          || (s === 0 && e.isVertical())
    ...
    updateSlides() {
      ...
      const d = g(i, `.${e.params.slideClass}, swiper-slide`);
      const c = l ? e.virtual.slides.length : d.length;
      let p = [];
      const u = [];
      const h = [];
      let f = s.slidesOffsetBefore;
      typeof f === 'function' && (f = s.slidesOffsetBefore.call(e));
      ...
      s.cssMode
          && (m(a, '--swiper-slides-offset-before', `${f}px`),
          m(a, '--swiper-slides-offset-after', `${v}px`)));
      const P = s.grid && s.grid.rows > 1 && e.grid;
      let L;
      P ? e.grid.initSlides(d) : e.grid && e.grid.unsetSlides();
      const I = s.slidesPerView === 'auto'
        && s.breakpoints
      ...
      for (let a = 0; a < c; a += 1) {
        ...
        if (
          !i
          || (P && e.grid.updateSlide(a, i, d), y(i, 'display') !== 'none')
        ) {
          if (l && s.slidesPerView === 'auto') {
            ...
            const r = i.style.transform;
            const n = i.style.webkitTransform;
            if (
              (r && (i.style.transform = 'none'),
              n && (i.style.webkitTransform = 'none'),
              s.roundLengths)
            ) { L = e.isHorizontal() ? T(i, 'width', !0) : T(i, 'height', !0); } else {
              const e = t(a, 'width');
              const s = t(a, 'padding-left');
              const r = t(a, 'padding-right');
              const n = t(a, 'margin-left');
              const l = t(a, 'margin-right');
              const o = a.getPropertyValue('box-sizing');
              if (o && o === 'border-box') L = e + n + l;
              else {
      ...
      if (
        ...
        const t = s.slidesPerView !== 'auto' && s.slidesPerView % 1 != 0;
        const a = s.snapToSlideEdge && !s.loop && (s.slidesPerView === 'auto' || t);
        let i = p.length;
        if (a) {
          let e;
          if (s.slidesPerView === 'auto') {
            ...
            for (
              let s = h.length - 1;
              s >= 0 && ((t += h[s] + (s < h.length - 1 ? x : 0)), t <= E);
              s -= 1
            ) { e = h.length - s; }
        ...
        for (let t = 0; t < p.length; t += 1) {
          ...
          a ? t <= i && r.push(n) : p[t] <= e.virtualSize - E && r.push(n));
        }
        ((p = r),
        Math.floor(e.virtualSize - E) - Math.floor(p[p.length - 1]) > 1
            && (a || p.push(e.virtualSize - E)));
      }
      if (l && s.loop) {
        const t = h[0] + x;
        ...
        for (
          ...
          (s.slidesPerGroup === 1 && p.push(p[p.length - 1] + t),
          u.push(u[u.length - 1] + t),
          (e.virtualSize += t));
        }
      }
      if ((p.length === 0 && (p = [0]), x !== 0)) {
        const t = e.isHorizontal() && r
          ? 'marginLeft'
      ...
      if (
        ...
        const a = e.el.classList.contains(t);
    ...
    updateSlidesProgress(e = (this && this.translate) || 0) {
      const t = this;
      const s = t.params;
      const { slides: a, rtlTranslate: i, snapGrid: r } = t;
      ...
      for (let e = 0; e < a.length; e += 1) {
        ...
        const c = (n + (s.centeredSlides ? t.minTranslate() : 0) - d)
            / (o.swiperSlideSize + l);
        const p = (n - r[0] + (s.centeredSlides ? t.minTranslate() : 0) - d)
            / (o.swiperSlideSize + l);
        const u = -(n - d);
        const m = u + t.slidesSizesGrid[e];
        const h = u >= 0 && u <= t.size - t.slidesSizesGrid[e];
        const f = (u >= 0 && u < t.size - 1)
            || (m > 1 && m <= t.size)
            || (u <= 0 && m >= t.size);
    ...
    updateProgress(e) {
      ...
      if (a === 0) ((i = 0), (r = !0), (n = !0));
        ...
        const l = Math.abs(e - t.maxTranslate()) < 1;
        ((r = s || i <= 0), (n = l || i >= 1), s && (i = 0), l && (i = 1));
      }
      if (s.loop) {
        const s = t.getSlideIndexByData(0);
        const a = t.getSlideIndexByData(t.slides.length - 1);
        const i = t.slidesGrid[s];
        const r = t.slidesGrid[a];
        const n = t.slidesGrid[t.slidesGrid.length - 1];
        const o = Math.abs(e);
    ...
    updateSlidesClasses() {
      ...
      const r = e.virtual && s.virtual.enabled;
      const n = e.grid && s.grid && s.grid.rows > 1;
      const l = (e) => g(a, `.${s.slideClass}${e}, swiper-slide${e}`)[0];
      let o; let d; let
        c;
      if (r) {
        if (s.loop) {
    ...
    updateActiveIndex(e) {
      ...
      let u;
      if (t.virtual && i.virtual.enabled) u = i.loop ? c(d) : d;
      else if (p) {
  ...
  const N = {
    ...
    translateTo(e = 0, t = this.params.speed, s = !0, a = !0, i) {
      const r = this;
      const { params: n, wrapperEl: l } = r;
      if (r.animating && n.preventInteractionOnTransition) return !1;
      const o = r.minTranslate();
      const d = r.maxTranslate();
      let c;
      if (
        ((c = a && e > o ? o : a && e < d ? d : e),
        r.updateProgress(c),
        ...
        if (t === 0) l[e ? 'scrollLeft' : 'scrollTop'] = -c;
        else {
  ...
  const V = {
    slideTo(e = 0, t, s = !0, a, i) {
      ...
      if (l.normalizeSlideIndex) {
        for (let e = 0; e < d.length; e += 1) {
          ...
          const s = Math.floor(100 * d[e]);
          const a = Math.floor(100 * d[e + 1]);
          void 0 !== d[e + 1]
            ? t >= s && t < a - (a - s) / 2
              ? (n = e)
              : t >= s && t < a && (n = e + 1)
      ...
      if (!(y && i) && ((u && -w === r.translate) || (!u && w === r.translate))) {
        return (
          ...
          b !== 'reset' && (r.transitionStart(s, b), r.transitionEnd(s, b)),
          !1
        );
      }
      if (l.cssMode) {
      ...
      if (i.params.loop) {
        if (i.virtual && i.params.virtual.enabled) n += i.virtual.slidesBefore;
          ...
          if (
            ...
            a && d && i.params.slidesPerView !== 'auto' && !r && (p = !1),
            p)
          ) {
            const s = d
              ? e < i.activeIndex
            ...
            i.loopFix({
              direction: s,
              slideTo: !0,
              activeSlideIndex: s === 'next' ? e + 1 : e - t + 1,
              slideRealIndex: s === 'next' ? i.realIndex : void 0,
            });
          }
          if (r) {
    ...
    slideNext(e, t = !0, s) {
      const a = this;
      const { enabled: i, params: r, animating: n } = a;
    ...
    slidePrev(e, t = !0, s) {
      ...
      const m = r.map((e) => p(e));
      const h = i.freeMode && i.freeMode.enabled;
      ...
      return i.loop && a.activeIndex === 0 && i.cssMode
        ? (requestAnimationFrame(() => {
          a.slideTo(g, e, t, s);
        }),
        !0)
    ...
    slideToClosest(e, t = !0, s, a = 0.5) {
      const i = this;
      if (i.destroyed) return;
      void 0 === e && (e = i.params.speed);
      let r = i.activeIndex;
      const n = Math.min(i.params.slidesPerGroupSkip, r);
      const l = n + Math.floor((r - n) / i.params.slidesPerGroup);
      const o = i.rtlTranslate ? i.translate : -i.translate;
      if (o >= i.snapGrid[l]) {
    ...
    slideToClickedSlide() {
      ...
      const a = t.slidesPerView === 'auto'
        ? e.slidesPerViewDynamic()
        : t.slidesPerView;
      let i;
      let r = e.getSlideIndexWhenGrid(e.clickedIndex);
      const n = e.isElement ? 'swiper-slide' : `.${t.slideClass}`;
      const o = e.grid && e.params.grid && e.params.grid.rows > 1;
      if (t.loop) {
  ...
  const q = {
    loopCreate(e, t) {
      ...
      const n = s.grid && a.grid && a.grid.rows > 1;
      ...
      const o = s.slides.length % l !== 0;
      const d = n && s.slides.length % a.grid.rows !== 0;
      const c = (e) => {
        for (let t = 0; t < e; t += 1) {
          const e = s.isElement
    ...
    loopFix({
      ...
      d.length < y + x || (o.params.effect === 'cards' && d.length < y + 2 * x)
        ? v(
      ...
      const T = [];
      const M = [];
      const C = S ? Math.ceil(d.length / m.grid.rows) : d.length;
      const P = r && C - w < y && !b;
  ...
  function _(e, t, s) {
    const a = r();
    const { params: i } = e;
    const n = i.edgeSwipeDetection;
    const l = i.edgeSwipeThreshold;
    return (
      !n
      || !(s <= l || s >= a.innerWidth - l)
      || (n === 'prevent' && (t.preventDefault(), !0))
    );
  }
  function F(e) {
    const t = this;
    ...
    if (i.type === 'touchstart') return void _(t, i, i.targetTouches[0].pageX);
    const { params: l, touches: d, enabled: c } = t;
    if (!c) return;
    if (!l.simulateTouch && i.pointerType === 'mouse') return;
    ...
    if ('which' in i && i.which === 3) return;
    if ('button' in i && i.button > 0) return;
    if (n.isTouched && n.isMoved) return;
    const u = !!l.noSwipingClass && l.noSwipingClass !== '';
    const m = i.composedPath ? i.composedPath() : i.path;
    u && i.target && i.target.shadowRoot && m && (p = m[0]);
    const h = l.noSwipingSelector
      ? l.noSwipingSelector
      : `.${l.noSwipingClass}`;
    const f = !(!i.target || !i.target.shadowRoot);
    if (
      l.noSwiping
      && (f
        ? (function (e, t = this) {
    ...
    (p.matches(n.focusableElements)
      && ((w = !1), p.nodeName === 'SELECT' && (n.isTouched = !1)),
    s.activeElement
        && s.activeElement.matches(n.focusableElements)
        && s.activeElement !== p
        && (i.pointerType === 'mouse'
          || (i.pointerType !== 'mouse' && !p.matches(n.focusableElements)))
  ...
  function W(e) {
    ...
    if (!d) return;
    if (!r.simulateTouch && e.pointerType === 'mouse') return;
    let c;
    let p = e;
    if ((p.originalEvent && (p = p.originalEvent), p.type === 'pointermove')) {
    ...
    if (
      ...
      void 0 === i.startMoving
        && ((n.currentX === n.startX && n.currentY === n.startY)
          || (i.startMoving = !0)),
      i.isScrolling
        || (p.type === 'touchmove' && i.preventTouchMoveFromPointerMove))
  ...
  function j(e) {
    ...
    if (!p) return;
    if (!r.simulateTouch && i.pointerType === 'mouse') return;
    if (
    ...
    if (m > r.longSwipesMs) {
      ...
      && (i.target === t.navigation.nextEl || i.target === t.navigation.prevEl)
        ? i.target === t.navigation.nextEl
          ? t.slideTo(g + E)
          : t.slideTo(g)
        : (t.swipeDirection === 'next' && t.slideTo(w !== null ? w : g + E),
  ...
  function U() {
    ...
    if (
      ...
      const t = n ? e.virtual.slides : e.slides;
  ...
  function Z() {
    ...
    ((i = r === 0 ? 0 : (e.translate - e.minTranslate()) / r),
  ...
  const ie = {
    ...
    breakpoints: {
      setBreakpoint() {
        ...
        const l = a();
        const o = i.breakpointsBase !== 'window' && i.breakpointsBase
          ? 'container'
          : i.breakpointsBase;
        const d = ['window', 'container'].includes(i.breakpointsBase)
              || !i.breakpointsBase
          ? e.el
          : l.querySelector(i.breakpointsBase);
        const c = e.getBreakpoint(n, o, d);
        if (!c || e.currentBreakpoint === c) return;
        const p = (c in n ? n[c] : void 0) || e.originalParams;
        const m = te(e, i);
        const h = te(e, p);
        const f = e.params.grabCursor;
        const g = p.grabCursor;
        const v = i.enabled;
        (m && !h
          ? (r.classList.remove(
        ...
        ['navigation', 'pagination', 'scrollbar'].forEach((t) => {
          ...
          const a = p[t] && p[t].enabled;
          (s && !a && e[t].disable(), !s && a && e[t].enable());
        }));
        const w = p.direction && p.direction !== i.direction;
        const b = i.loop && (p.slidesPerView !== i.slidesPerView || w);
        const y = i.loop;
      ...
      getBreakpoint(e, t = 'window', s) {
        if (!e || (t === 'container' && !s)) return;
        let a = !1;
        const i = r();
        const n = t === 'window' ? i.innerHeight : s.clientHeight;
        const l = Object.keys(e).map((e) => {
    ...
    checkOverflow: {
      checkOverflow() {
        const e = this;
        const { isLocked: t, params: s } = e;
        const { slidesOffsetBefore: a } = s;
        if (a) {
          const t = e.slides.length - 1;
          const s = e.slidesGrid[t] + e.slidesSizesGrid[t] + 2 * a;
          e.isLocked = e.size > s;
  ...
  class ne {
    ...
    getSlideIndex(e) {
      ...
      const a = E(g(t, `.${s.slideClass}, swiper-slide`)[0]);
      return E(e) - a;
    }
    ...
    slidesPerViewDynamic(e = 'current', t = !1) {
      ...
      if (s.centeredSlides) {
        let e;
        let t = a[l] ? Math.ceil(a[l].swiperSlideSize) : 0;
    ...
    update() {
      ...
      ) { (a(), s.autoHeight && e.updateAutoHeight()); } else {
        if (
      ...
      const l = (t, s = {}) => {
        const r = new (n.MutationObserver || n.WebkitMutationObserver)(
          (t) => {
            ...
            if (t.length === 1) return void a('observerUpdate', t[0]);
            const s = function () {
  ...
  function ce(e) {
    ...
    if (typeof e === 'object' && 'length' in e) { for (let t = 0; t < e.length; t += 1) e[t] && i(e[t]); } else i(e);
    (t.recalcSlides(),
    s.loop && t.loopCreate(),
  ...
  function pe(e) {
    const t = this;
    const { params: s, activeIndex: a, slidesEl: i } = t;
    s.loop && t.loopDestroy();
    let r = a + 1;
    const n = (e) => {
      if (typeof e === 'string') {
  ...
  function ue(e, t) {
    const s = this;
    const { params: a, activeIndex: i, slidesEl: r } = s;
    let n = i;
  ...
  function me(e) {
    const t = this;
    const { params: s, activeIndex: a } = t;
    let i = a;
  ...
  const be = [
    function ({
      ...
      function o(t, s) {
        ...
        return (
          a.renderSlide
            ...
            typeof i === 'string' && (P(l, i), (i = l.children[0])))
            : (i = e.isElement
              ? w('swiper-slide')
      ...
      function d(t, s, a) {
        ...
        const A = (e) => {
          let t = e;
          return (
            e < 0 ? (t = v.length + e) : t >= v.length && (t -= v.length),
            t
          );
        };
        if (t) {
      ...
      Object.assign(e.virtual, {
        ...
        prependSlide(t) {
          ...
          if (e.params.virtual.cache) {
            ...
            (Object.keys(t).forEach((e) => {
              const a = t[e];
              const r = a.getAttribute('data-swiper-slide-index');
              (r
                  && a.setAttribute(
    ...
    function ({
      ...
      function o(t) {
        ...
        const o = e.params.keyboard.pageUpDown;
        const d = o && r === 33;
        const c = o && r === 34;
        const p = r === 37;
        const u = r === 39;
        ...
        const f = e.params.keyboard.speed;
        (e.isHorizontal()
          ? ((d || c || p || u)
              && (a.preventDefault ? a.preventDefault() : (a.returnValue = !1)),
          (((c || u) && !s) || ((d || p) && s)) && e.slideNext(f),
          (((d || p) && !s) || ((c || u) && s)) && e.slidePrev(f))
          : ((d || c || m || h)
              && (a.preventDefault ? a.preventDefault() : (a.returnValue = !1)),
          (c || h) && e.slideNext(f),
          (d || m) && e.slidePrev(f)),
    ...
    function ({
      ...
      function d() {
        ...
        const r = (s, a) => {
          if (s) {
            ...
            s.addEventListener('click', a === 'next' ? o : l);
          }
      ...
      function c() {
        ...
        ((t = M(t)), (s = M(s)));
        const a = (t, s) => {
          (t.removeEventListener('click', s === 'next' ? o : l),
          t.classList.remove(
    ...
    function ({
      ...
      function o(t, s) {
        ...
        t
          && (t = t[`${s === 'prev' ? 'previous' : 'next'}ElementSibling`])
          && (t.classList.add(`${a}-${s}`),
          (t = t[`${s === 'prev' ? 'previous' : 'next'}ElementSibling`])
      ...
      function c() {
          ...
          if (
            ...
            a.forEach((e) => {
              const t = [
                ...
                .map((e) => (typeof e === 'string' && e.includes(' ') ? e.split(' ') : e))
                .flat();
        ...
        c.forEach((t, r) => {
          ...
          (s.type === 'custom' && s.renderCustom
            ...
            r === 0 && a('paginationRender', t))
            : (r === 0 && a('paginationRender', t), a('paginationUpdate', t)),
          e.params.watchOverflow
              && e.enabled
      ...
      function p() {
        ...
        t.type !== 'custom' && a('paginationRender', i[0]));
      }
      function u() {
      ...
      s('enable disable', () => {
        ...
        t
            && ((t = M(t)),
            t.forEach((t) => t.classList[e.enabled ? 'remove' : 'add'](
    ...
    function ({
      ...
      function f() {
        ...
        const { dragEl: a, el: i } = t;
        const r = e.params.scrollbar;
        const n = e.params.loop ? e.progressLoop : e.progress;
        let l = d;
        let o = (c - d) * n;
        (s
          ? ((o = -o),
      ...
      function g() {
        ...
        (d = e.params.scrollbar.dragSize === 'auto'
          ? c * p
      ...
      function E(t) {
        ...
        const { scrollbar: a, wrapperEl: r } = e;
        const { el: n, dragEl: l } = a;
        ((u = !0),
        (o = t.target === l
          ? v(t)
      ...
      function T(t) {
        ...
        if (!i) return;
        const n = i;
        const l = !!a.passiveListeners && { passive: !1, capture: !1 };
        const o = !!a.passiveListeners && { passive: !0, capture: !1 };
        if (!n) return;
        const d = t === 'on' ? 'addEventListener' : 'removeEventListener';
        (n[d]('pointerdown', E, l),
        r[d]('pointermove', x, l),
      ...
      function C() {
        ...
        if (
          ...
          i || typeof a.el !== 'string')
        ) { i || (i = a.el); } else if (((i = r.querySelectorAll(a.el)), !i.length)) return;
        (e.params.uniqueNavElements
          && typeof a.el === 'string'
          && i.length > 1
          && s.querySelectorAll(a.el).length === 1
    ...
    function ({ swiper: e, extendParams: t, on: s }) {
      ...
      const i = (t, s) => {
        const { rtl: a } = e;
        const i = a ? -1 : 1;
        const r = t.getAttribute('data-swiper-parallax') || '0';
        let n = t.getAttribute('data-swiper-parallax-x');
        let l = t.getAttribute('data-swiper-parallax-y');
        const o = t.getAttribute('data-swiper-parallax-scale');
        const d = t.getAttribute('data-swiper-parallax-opacity');
        const c = t.getAttribute('data-swiper-parallax-rotate');
        if (
          (n || l
            ? ((n = n || '0'), (l = l || '0'))
            : e.isHorizontal()
        ...
        e.params.parallax.enabled
            && ((t = e.params.speed) => {
              ...
              r.forEach((e) => {
                ...
                (t === 0 && (s = 0), (e.style.transitionDuration = `${s}ms`));
              }));
            })(s);
      }));
    },
    function ({
      ...
      function S() {
        ...
        const s = h.imageWrapEl.getAttribute('data-swiper-zoom') || t.maxRatio;
      ...
      function C(t) {
        if ((t.pointerType === 'mouse' && m.splice(0, m.length), !T(t))) return;
      ...
      function P(t) {
        ...
        const s = e.params.zoom;
        const a = e.zoom;
        const i = m.findIndex((e) => e.pointerId === t.pointerId);
        (i >= 0 && (m[i] = t),
        m.length < 2
            || ((l = !0),
            (h.scaleMove = E()),
      ...
      function L(t) {
        if (!T(t)) return;
        if (t.pointerType === 'mouse' && t.type === 'pointerout') return;
        const s = e.params.zoom;
        const a = e.zoom;
        const i = m.findIndex((e) => e.pointerId === t.pointerId);
        (i >= 0 && m.splice(i, 1),
      ...
      function z(t) {
        const s = t.pointerType === 'mouse' && e.params.zoom.panOnMouseMove;
        if (!T(t) || !M(t)) return;
        const a = e.zoom;
        if (!h.imageEl) return;
        ...
        const { originX: l, originY: p } = h;
        ((f.currentX = f.touchesCurrent.x
          - f.touchesStart.x
          + f.startX
          + n * (f.width - 2 * l)),
        (f.currentY = f.touchesCurrent.y
            - f.touchesStart.y
            + f.startY
            + n * (f.height - 2 * p)),
        f.currentX < f.minX
        ...
        (v.x = (f.touchesCurrent.x - v.prevPositionX)
            / (Date.now() - v.prevTime)
            / 2),
        (v.y = (f.touchesCurrent.y - v.prevPositionY)
            / (Date.now() - v.prevTime)
            / 2),
      ...
      function $(e) {
        ...
        const r = -3 * (e.clientY - u.y);
        const n = f.width * o;
        const l = f.height * o;
        const d = h.slideWidth;
        const c = h.slideHeight;
        const m = Math.min(d / 2 - n / 2, 0);
        const g = -m;
        const v = Math.min(c / 2 - l / 2, 0);
        const w = -v;
        const b = Math.max(Math.min(f.startX + a, g), m);
        const y = Math.max(Math.min(f.startY + r, w), v);
        ((h.imageWrapEl.style.transitionDuration = '0ms'),
      ...
      function k(t) {
        ...
        let r; let n; let l; let d; let c; let p; let u; let m; let v; let w; let y; let E; let T; let M; let C; let P; let L; let
          I;
        ((h.maxRatio = S()),
        e.params.cssMode
            && ((e.wrapperEl.style.overflow = 'hidden'),
        ...
        const z = o;
        const A = typeof t === 'number' ? t : null;
        o === 1
          && A
          && ((r = void 0),
          (n = void 0),
        ...
        !t || (o === 1 && A)
          ...
          m < M && (m = M),
          m > P && (m = P)),
        A && s.scale === 1 && ((h.originX = 0), (h.originY = 0)),
        (f.currentX = u),
        (f.currentY = m),
      ...
      s('touchEnd', (t, s) => {
        e.zoom.enabled
            && (function () {
              ...
              let a = 300;
              const i = v.x * s;
              const r = f.currentX + i;
              const n = v.y * a;
              const l = f.currentY + n;
              (v.x !== 0 && (s = Math.abs((r - f.currentX) / v.x)),
              v.y !== 0 && (a = Math.abs((l - f.currentY) / v.y)));
              const o = Math.max(s, a);
              ((f.currentX = r), (f.currentY = l));
              const d = f.width * t.scale;
              const c = f.height * t.scale;
        ...
        if (
          ...
          return void (
            ...
            if (
              ...
              t && t.swiper)
            ) { e.controller.control.push(t.swiper); } else if (t) {
      ...
      Object.assign(e.controller, {
        setTranslate(t, s) {
          ...
          function o(t) {
            ...
            (n && e.params.controller.by !== 'container')
    ...
    function ({ swiper: e, extendParams: t, on: s }) {
      ...
      const C = (t) => {
        ...
        const n = (a
          ...
          : e.slides.indexOf(s)) === e.activeIndex;
        const o = e.params.watchSlidesProgress
              && e.visibleSlides
              ...
              i
                || (e.params.loop
                  ...
                  : a
                    ...
                    : e.slideTo(
                      e.getSlideIndexWhenGrid(e.slides.indexOf(s)),
                      0,
                    ),
                (i = !1));
            }));
      ...
      (i('init', () => {
        e.params.hashNavigation.enabled
          && (() => {
            ...
            if (t) {
              const s = 0;
              const a = e.params.hashNavigation.getSlideIndex(e, t);
    ...
    function ({
      ...
      let m;
      let h;
      let f = r && r.autoplay ? r.autoplay.delay : 3e3;
      ...
      function w(t) {
        e
          ...
          h || (t.detail && t.detail.bySwiperTouchMove) || M());
      }
      const b = () => {
      ...
      const y = () => {
        ...
        return (!Number.isNaN(s) && s > 0 && (t = s), t);
      };
      const E = (t) => {
        if (e.destroyed || !e.autoplay.running) return;
        (cancelAnimationFrame(l), b());
        let s = t;
        (void 0 === s && ((s = y()), (f = s), (g = s)), (o = s));
      ...
      const C = () => {
        if (e.destroyed || !e.autoplay.running) return;
        const t = a();
        (t.visibilityState === 'hidden' && ((m = !0), T(!0)),
        t.visibilityState === 'visible' && M());
      };
      const P = (t) => {
        t.pointerType === 'mouse'
            && ((m = !0), (h = !0), e.animating || e.autoplay.paused || T(!0));
      };
      const L = (t) => {
        t.pointerType === 'mouse' && ((h = !1), e.autoplay.paused && M());
      };
      (s('init', () => {
    ...
    function ({ swiper: e, extendParams: t, on: s }) {
      ...
      function n() {
        ...
        return (
          !(!t || t.destroyed) && t.params.virtual && t.params.virtual.enabled
        );
      }
      function l() {
        const t = e.thumbs.swiper;
      ...
      function d(t, s) {
        ...
        if (
          ...
          (i = Math.floor(i)),
          a.slides.forEach((e) => e.classList.remove(r)),
          a.params.loop || n())
        ) {
          for (let t = 0; t < i; t += 1) {
            g(
          ...
          for (let t = 0; t < i; t += 1) {
            a.slides[e.realIndex + t]
              && a.slides[e.realIndex + t].classList.add(r);
          }
        }
        (s?.autoScroll ?? 1)
          && (function (t) {
            ...
            const a = s.params.slidesPerView === 'auto'
              ? s.slidesPerViewDynamic()
              : s.params.slidesPerView;
            const i = e.params.thumbs.autoScrollOffset;
            const r = i && !s.params.loop;
            if (e.realIndex !== s.realIndex || r) {
              ...
              if (s.params.loop) {
                const t = s.slides.find(
                  (t) => t.getAttribute('data-swiper-slide-index')
                    === `${e.realIndex}`,
                );
      ...
      s('beforeInit', () => {
        ...
        if (t && t.swiper) {
          if (
            ...
            const s = a();
            const i = () => {
              const a = typeof t.swiper === 'string'
                ? s.querySelector(t.swiper)
                : t.swiper;
              if (a && a.swiper) ((t.swiper = a.swiper), o(), d(!0));
              else if (a) {
                const s = `${e.params.eventsPrefix}init`;
                const i = (r) => {
                  ((t.swiper = r.detail[0]),
            ...
            if (t < -e.minTranslate()) e.slideTo(e.activeIndex);
              ...
              if (i.freeMode.momentum) {
                if (d.velocities.length > 1) {
                  ...
                  const a = t.position - s.position;
                  const r = t.time - s.time;
                  ((e.velocity = a / r),
                  (e.velocity /= 2),
                ...
                if (
                  ...
                  if (
                    ...
                    const a = e.slidesSizesGrid[e.activeIndex];
                    t = s < a
                      ? i.speed
                      : s < 2 * a
                        ? 1.5 * i.speed
    ...
    function ({ swiper: e, extendParams: t, on: s }) {
      ...
      (e.grid = {
        initSlides: (t) => {
          ...
          const { rows: n, fill: l } = e.params.grid;
          const o = e.virtual && e.params.virtual.enabled
            ? e.virtual.slides.length
            : t.length;
          ((r = Math.floor(o / n)),
        ...
        updateSlide: (t, s, n) => {
          ...
          const d = l();
          const { rows: c, fill: p } = e.params.grid;
          const u = e.virtual && e.params.virtual.enabled
            ? e.virtual.slides.length
            : n.length;
          let m; let h; let
            f;
          if (p === 'row' && o > 1) {
            ...
            const i = t - c * o * e;
            const r = e === 0 ? o : Math.min(Math.ceil((u - e * c * o) / c), o);
            ((f = Math.floor(i / r)),
            (h = i - f * r + e * o),
            (m = h + (f * a) / c),
            (s.style.order = m));
      ...
      fe({
        ...
        setTranslate: () => {
          ...
          if (
            ...
            if (u) { h.style.transform = `translate3d(0px, ${r / 2 + p.shadowOffset}px, ${-r / 2}px) rotateX(89.99deg) rotateZ(0deg) scale(${p.shadowScale})`; } else {
              const e = Math.abs(f) - 90 * Math.floor(Math.abs(f) / 90);
              const t = 1.5
                  - (Math.sin((2 * e * Math.PI) / 360) / 2
                    + Math.cos((2 * e * Math.PI) / 360) / 2);
              const s = p.shadowScale;
              const a = p.shadowScale / t;
              const i = p.shadowOffset;
    ...
    function ({ swiper: e, extendParams: t, on: s }) {
      ...
      fe({
        ...
        setTranslate: () => {
          ...
          const l = e.translate;
          const o = n ? t / 2 - l : s / 2 - l;
          const d = n ? r.rotate : -r.rotate;
          const c = r.depth;
          const p = C(e);
          for (let e = 0, t = a.length; e < t; e += 1) {
            const t = a[e];
            const s = i[e];
            const l = (o - t.swiperSlideOffset - s / 2) / s;
            const u = typeof r.modifier === 'function'
              ? r.modifier(l)
              : l * r.modifier;
            let m = n ? d * u : 0;
            let h = n ? 0 : d * u;
    ...
    function ({ swiper: e, extendParams: t, on: s }) {
      ...
      const a = (e) => (typeof e === 'string' ? e : `${e}px`);
      fe({
        effect: 'creative',
        swiper: e,
        on: s,
        setTranslate: () => {
          ...
          const r = e.params.creativeEffect;
          const { progressMultiplier: n } = r;
          const l = e.params.centeredSlides;
          const o = C(e);
          if (l) {
          ...
          for (let s = 0; s < t.length; s += 1) {
            ...
            const m = [e.params.cssMode ? -u - e.translate : -u, 0, 0];
            const h = [0, 0, 0];
            let f = !1;
            ...
            const v = m.join(', ');
            const w = `rotateX(${o(h[0])}deg) rotateY(${o(h[1])}deg) rotateZ(${o(h[2])}deg)`;
            const b = p < 0
    ...
    function ({ swiper: e, extendParams: t, on: s }) {
      ...
      fe({
        ...
        setTranslate: () => {
          ...
          const i = e.params.cardsEffect;
          const { startTranslate: r, isTouched: n } = e.touchEventsData;
          const l = a ? -e.translate : e.translate;
          for (let o = 0; o < t.length; o += 1) {
            const d = t[o];
            const c = d.progress;
            const p = Math.min(Math.max(c, -4), 4);
            ...
            let g = 1;
            let v = -i.perSlideRotate * p;
            let w = i.perSlideOffset - 0.75 * Math.abs(p);
            const b = e.virtual && e.params.virtual.enabled
              ? e.virtual.from + o
              : o;
            const y = (b === s || b === s - 1)
                  && p > 0
