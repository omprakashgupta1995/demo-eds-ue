  ...
  return (
    ...
    (t.bindArrows = function () {
      ...
      i.opt.arrows
        ...
        : Object.keys(i.arrows).forEach((e) => {
            e = i.arrows[e];
    ...
    (t.updateControls = function (e) {
      ...
      let d = Math.floor(n.opt.slidesToShow) % 2 ? 0 : a + 1;
      Math.floor(n.opt.slidesToShow) === 1 && (d = 0),
        n.ele.scrollLeft + n.containerWidth >= Math.floor(n.trackWidth) &&
          (n.page = n.dots ? n.dots.children.length - 1 : 0),
        [].forEach.call(n.slides, (e, t) => {
          const i = e.classList;
          var e = i.contains("visible");
          const o = n.ele.scrollLeft;
          const s = n.ele.scrollLeft + n.containerWidth;
          var r = n.itemWidth * t;
          const l = r + n.itemWidth;
          var r =
            ([].forEach.call(i, (e) => {
        ...
        n.dots &&
          [].forEach.call(n.dots.children, (e, t) => {
            e.classList.toggle("active", n.page === t);
          }),
        e &&
          n.opt.scrollLock &&
          (clearTimeout(n.scrollLock),
          (n.scrollLock = setTimeout(() => {
            clearTimeout(n.scrollLock),
              Math.abs(n.ele.scrollLeft / n.itemWidth - n.slide) > 0.02 &&
                (n.mouseDown ||
    ...
    (t.scrollItem = function (e, t, i) {
      ...
      const s = this;
      const r = e;
      var i = (++s.animate_id, s.slide);
      var l =
        !0 === t
          ? (e = Math.round((e * s.containerWidth) / s.itemWidth)) * s.itemWidth
          : (typeof e === "string" &&
              ((l = e === "prev"),
              (e =
      ...
      return (
        ...
        s.scrollTo(l, s.opt.duration * Math.abs(s.ele.scrollLeft - l), () => {
          s.updateControls(),
            s.emit("animated", {
              value: r,
    ...
    (t.settingsBreakpoint = function () {
      ...
      if (t) {
        t.sort((e, t) => t.breakpoint - e.breakpoint);
        for (let i = 0; i < t.length; ++i) {
          const o = t[i];
          if (a.innerWidth >= o.breakpoint)
            return (
              e.breakpoint !== o.breakpoint &&
              ((e.opt = { ...e._opt, ...o.settings }),
              (e.breakpoint = o.breakpoint),
              !0)
            );
        }
      }
      const s = e.breakpoint !== 0;
      return (e.opt = { ...e._opt }), (e.breakpoint = 0), s;
    }),
    (t.scrollTo = function (t, i, o) {
      const s = this;
      const r = new Date().getTime();
      const l = s.animate_id;
      const n = function () {
    ...
    (t.destroy = function () {
      function e(t) {
        t.removeAttribute("style"),
          [].forEach.call(t.classList, (e) => {
            /^glider/.test(e) && t.classList.remove(e);
          });
      }
      const t = this;
      const i = t.ele.cloneNode(!0);
    ...
    (t.event = function (e, t, i) {
      const o = e[`${t}EventListener`].bind(e);
