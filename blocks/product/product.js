export default function decorate(block) {
  ...
  if (headerRow) {
    ...
    const tagline = taglineWrapper?.querySelector("p");
    ...
    const ctaText = ctaWrapper?.querySelector("p");
    ...
    if (ctaText) {
      ...
      ctaLabel.textContent = ctaText.textContent;
    ...
    if (titleWrapper) {
      titleWrapper.replaceChildren(productTitleWrapper);
    }
  ...
  cards.forEach((card) => {
    ...
    newContentWrapper.classList.add("product-content");
    ...
    if (arrow) {
      ...
      arrowWrapper.classList.add("product-arrow");
    ...
    contentWrapper?.replaceWith(newContentWrapper);
