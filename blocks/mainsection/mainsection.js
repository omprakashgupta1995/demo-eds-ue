export default function decorate(block) {
    ...
    sections.forEach((section, sectionIndex) => {
        ...
        // Handle existing ul.product-card structures - ONLY for section-2
...
if (window.location.href.includes('/karishmagosalia/fragement/three-five-years')) {

    const mainDiv = document.querySelector('main');
    let mainwrapper = document.createElement('div');

    mainwrapper.classList.add('main-wrapper');
    mainDiv.append(mainwrapper);

    /* Wrap into setTimout as Section element is generated in some time --> quick fix */
    setTimeout(() => {
        let section1 = document.querySelector('.section-1');
        let section2 = document.querySelector('.section-2');
        mainwrapper.append(section1);
        mainwrapper.append(section2);
    }, 1000);
}
